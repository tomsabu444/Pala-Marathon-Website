  ...
  return (
    <div className="flex font-outfit mx-auto flex-col p-8 w-full max-w-7xl  ">
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          For the safety of all participants, roller skates, bicycles, or other
          devices are prohibited. Strollers are permitted for children.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          All entry fees are non-refundable. Race bibs are non-transferable and
          must not be swapped or transferred to another runner. Violation will
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          The event may be canceled due to unforeseen circumstances. Organizers
          are not liable for any costs incurred.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          By registering, participants agree to the collection and use of their
          information for event organization, promotion, and future activities
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          Participants under 9 years must be accompanied by an adult. Ages 10-18
          do not require adult supervision.
        </p>
      </section>
