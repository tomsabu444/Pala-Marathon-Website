    ...
    <div className="flex font-outfit mx-auto flex-col p-8 w-full max-w-7xl ">
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          ...
          faith, but no representation or warranty, express or implied, is made
          about the accuracy, adequacy, validity, reliability, or completeness
          of the information.
        </p>
        <p className="text-gray-600">
          Under no circumstance shall the Pala Marathon organizers, including
          Lions Clubs International District 318B, St. Thomas College, Pala, and
          Engineers' Forum, Pala, be liable for any loss or damage incurred as a
          result of using the website or participating in the event.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          ...
          liability for any injuries, health conditions, or adverse events that
          may arise before, during, or after the marathon.
        </p>
        <p className="text-gray-600">
          By registering, participants acknowledge their own responsibility for
          health and safety and agree to seek medical advice if necessary.
        </p>
      </section>
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          ...
          organizations, including title sponsors and other supporters. Sponsors
          are acknowledged on race materials and other promotional media as
          specified by sponsorship agreements. These sponsorships do not imply
          endorsement by the marathon organizers of the sponsors' products or
          services.
        </p>
        <p className="text-gray-600">
      ...
      <section className="mb-4">
        ...
        <p className="text-gray-600">
          ...
          and legacy building aspects promoted by the event are aspirational and
          do not guarantee specific outcomes for participants or the local
          community.
        </p>
        <p className="text-gray-600">
          The organizers reserve the right to modify or cancel event details in
          response to unforeseen circumstances or changes in community needs,
          without any liability to participants.
        </p>
      </section>
      ...
      <section className="mt-6 text-center">
        <p className="text-sm text-gray-500">
          By using the Pala Marathon website or participating in the event, you
