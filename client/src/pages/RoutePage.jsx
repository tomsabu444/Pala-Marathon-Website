        ...
        <div className="relative flex flex-col items-center md:items-start">
          ...
          <div className="w-full max-w-lg text-center md:text-left md:ml-24">
            ...
            <p className="relative font-outfit md:text-md text-gray-700 leading-relaxed mb-10">
              <b>Half Marathon (21.1 km):</b> Starts at{" "}
              <b>St. Thomas College Pala Gate 2</b> and goes via Pala town,
              Chethimattam, Moonnani, Edappadi and Bharananganam till{" "}
              <b>Melambara Sree Dharma Sastha temple Gopuram</b> and turns back
              to finish at <b>St. Thomas College Pala Gate 2 itself</b>.<br />
              <br />
              <b>10K Run (10 km):</b> Starts at{" "}
              <b>St. Thomas College Pala Gate 2</b> and goes via Pala town,
              Chethimattam, Moonnani till <b>IMA Junction, Moonnani</b> and
              turns back to finish at{" "}
              <b>St. Thomas College Pala Gate 2 itself</b>.<br />
              <br />
              <b>Fun Run (3 km):</b> Starts at{" "}
              <b>Arunapuram-Manalelpadi road</b> (near St. Thomas College Pala
              Gate 2) and goes to Andoor Junction and turns back to finish at{" "}
              <b>St. Thomas College Pala Gate 2</b>.<br />
              <br />
            </p>
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center justify-center md:justify-start   md:gap-10 mt-8">
              ...
              <div className="text-center p-4 md:p-0 md:border-none">
                <h2 className="text-base text-[#330A48] font-bold">
                  HALF MARATHON
                </h2>
                <h3 className="text-2xl md:text-3xl text-[#8D1455] font-bold mt-1">
                  21KM
                </h3>
              </div>
              ...
              <div className="text-center  rounded-lg p-4   md:p-0 md:border-none">
                <h2 className="text-base text-[#330A48] font-bold">FUN RUN</h2>
                <h3 className="text-2xl md:text-3xl text-[#8D1455] font-bold mt-1">
                  3KM
                </h3>
              </div>
